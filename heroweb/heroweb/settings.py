"""
Django settings for heroweb project.
...
ALLOWED_HOSTS = ['herocall.eu-gb.mybluemix.net', '127.0.0.1']
...
WSGI_APPLICATION = 'heroweb.wsgi.application'
...
# Where Django redirects the user once the login is completed. The name used is the one defined in 'name'
# variable in the urls file
